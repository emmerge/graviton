...
MongoQuery = class MongoQuery extends MongoModifier {
  ...
  insert(callback) {
    ...
    return this.collection.insert(obj, callback);
  }
  ...
  update(options = {}, callback) {
    ...
    if (!_.isEmpty(mod)) {
      return this.collection.update(this.selector, this.modObject(), this.options, callback);
    }
  }

  remove(options = {}, callback) {
    _.extend(options, this.options);
    return this.collection.remove(this.selector, options, callback);
  }
};
