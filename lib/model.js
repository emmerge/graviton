Model = class Model {
   ...
   * Legacy API support
   */
  static extend(modelClassOrOptions) {
    var Mdl;
    if (modelClassOrOptions instanceof Graviton.Model) {
      Mdl = class extends this {}.mixin(modelClassOrOptions);
    } else {
      var BaseClass = _modelClassFromOptions(this, modelClassOrOptions);
...
function _modelClassFromOptions(BaseClass, options) {
