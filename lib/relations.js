...
Relation = class Relation extends MongoQuery {
  ...
  create(attributes = {}, callback) {
    var attrs = _.extend({}, attributes, this.selector);
    super(attrs, callback);
  }
...
class HasMany extends Relation {
  ...
  get selector() {
    return {[this.config.foreignKey]: this.model._id};
  }
}
...
class BelongsToMany extends Relation {
  ...
  get selector() {
    return {_id: this.model.get(this.config.field)};
  }
}
