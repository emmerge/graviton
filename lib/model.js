Model = class Model {
  ...
  save(callback) {
    if (this._id) {
      ...
      return _performUpdate.call(this, 'update', callback);
    } else {
      return _performUpdate.call(this, 'insert', callback);
    }
  }
...
function _performUpdate(method, callback) {
  if (callback) {
