...
Model = function(collectionName, obj) {
  this._collection = Graviton._collections[collectionName];
  if (!this._collection) throw new Error("Can't find collection: '"+collectionName+"'. Has it been defined?");
  ...
  // initializing a model directly (new Gravition.Model) will instantiate without any options
...
Model.extend = function(options, proto) {
  ...
  var Mdl = function(collectionName, obj) {
    this._super = self;
    this._options = opts;
    Model.call(this, collectionName, obj);
  };
